...
fake_dashboard_urls = [
    ...
    path('remove_discount/<int:order_id>',
         DiscountViewSet.as_view({'post': 'remove_discount'}, name='remove_discount')),
...
dashboard_urls = [
    ...
    path('dashboard_food_search_code/<str:food_code>',
         FoodViewSet.as_view({'get': 'food_search_code'}, name='food_search_code')),
    ...
    path('generate-datewise-report-pdf/<int:restaurant_id>/',
